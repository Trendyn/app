...
function installRoutes(app, ensureAuthenticated) {
  ...
  app.post('/votes', ensureAuthenticated,
    function(req, res, next) {
      ...
      Poll.postVote(req.body.id, req.session.passport.user, req.body.optionId,
  ...
  app.post('/opinions', ensureAuthenticated,
    function(req, res, next) {
      ...
      Poll.postOpinion(req.body.pollid, req.session.passport.user, req.body.opinion,
  ...
  app.post('/opinionlike', ensureAuthenticated,
    function(req, res, next) {
      ...
      Poll.postOpinionLike(req.body.id, req.session.passport.user,
